...
const Suppliers = () => {
  ...
  return (
    ...
    <div className='flex items-center justify-center py-3 px-7'>
        {/* <FilterDropdown /> */}
    <button type="button" onClick={()=>{setShowAddNewSupplier(true)}} class="text-[#cf4232] font-medium border-[#cf4232] border-2 text-lg  hover:bg-[#a84136] focus:ring-4 focus:ring-blue-300 hover:text-slate-100 rounded-lg text-md px-5 py-2.5 mr-2 mb-2 dark:bg-blue-600 mt-4 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Add New Supplier +</button>
    <button type="button" onClick={()=>{setShowAddNewVendor(true)}} class="text-[#cf4232] font-medium border-[#cf4232] border-2 text-lg  hover:bg-[#a84136] focus:ring-4 focus:ring-blue-300 hover:text-slate-100 rounded-lg text-md px-5 py-2.5 mr-2 mb-2 dark:bg-blue-600 mt-4 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Add Supplier QB +</button>
    </div>
