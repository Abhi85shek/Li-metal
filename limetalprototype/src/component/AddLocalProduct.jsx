...
const AddLocalProduct = () => {
    ...
    const [showModal,setShowModal] = useRecoilState(addNewLocalProductVisibleAtom);
   ...
   const addProductHandler= async ()=>{
        ...
        await axios.post('http://localhost:4000/createlocalItem', {productDetails: productDetails})
                        ...
                        <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                            ...
                            <form onSubmit={addProductHandler} className="w-[100%]">
                                ...
                                <div className=''>
                                    ...
                                    <input type="text" id="qbId" value={qbId} placeholder='Enter Quickbooks Id'  onChange={(e)=>{setQbId(e.target.value)}} className='shadow appearance-none border border-gray-700 rounded w-full py-2 px-3 text-gray-700 mb-3 leading-tight focus:outline-none focus:shadow-outline'/>
                                </div>
                                <div className=''>
...
export default AddLocalProduct;
